<?php
/**
 * Carousel Template for WooCommerce Related Products Pro
 *
 * This template displays related products in a horizontal carousel layout
...
$carousel_id = 'wrp-carousel-' . uniqid();
?>

<div class="wrp-related-products wrp-template-carousel">
    ...
    <div class="wrp-carousel-container" id="<?php echo esc_attr( $carousel_id ); ?>">
        <div class="wrp-carousel-track">
        ...
        <?php if ( count( $related_products ) > 4 ) : ?>
            <button class="wrp-carousel-prev wrp-carousel-nav">
                <span class="screen-reader-text"><?php echo esc_html__( 'Previous', 'woocommerce-related-products' ); ?></span>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <polyline points="15 18 9 12 15 6"></polyline>
                </svg>
            </button>
            <button class="wrp-carousel-next wrp-carousel-nav">
                <span class="screen-reader-text"><?php echo esc_html__( 'Next', 'woocommerce-related-products' ); ?></span>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
jQuery(document).ready(function($) {
    ...
    var $track = $carousel.find('.wrp-carousel-track');
    var $items = $carousel.find('.wrp-product-item');
    var $prev = $carousel.find('.wrp-carousel-prev');
    var $next = $carousel.find('.wrp-carousel-next');
