<?php
/**
 * List Template for WooCommerce Related Products Pro
 *
 * This template displays related products in a vertical list layout
...
<div class="wrp-related-products wrp-template-list">
